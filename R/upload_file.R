...
#' storage limit. See
#' [this page](https://beta.openai.com/docs/api-reference/files/upload) for
#' details.
#'
...
#' file to be uploaded. If the `purpose` is set to "search" or "answers",
...
#' the `purpose` is set to "classifications", each line is a JSON record
#' representing a single training example with "text" and "label" fields along
#' with an optional "metadata" field. If the `purpose` is set to
...
#' vector, one among `"search"`, `"answers"`, `"classifications"`,
#' and `"fine-tune"`. The intended purpose of the uploaded documents. This
